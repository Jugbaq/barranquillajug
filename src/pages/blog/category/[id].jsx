...
const PostsDetail = ( props ) => {
  ...
  return (
    <Layouts>
      ...
      <PageBanner pageTitle={postData.introTitle} breadTitle={postData.title} anchorLabel={"Publicaciones"} anchorLink={"#blog"} paddingBottom={1} />
                  ...
                  <div className="col-lg-8 mil-mb-30">
                      <div className="mil-adaptive-right mil-up">
                          ...
                          <ul className="mil-category-list">
                              ...
                              <li key={`categories-item-0`}><Link href="/blog">Todas</Link></li>
                          </ul>
                      </div>
                  </div>
              </div>
